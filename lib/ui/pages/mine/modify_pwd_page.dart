...
class ModifyPwdPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
        appBar: AppBar(
          title: Text(IntlUtil.getString(context, Ids.titleModifyPwd)),
        ),
          ...
          child: Column(
            ...
            children: <Widget>[
                  ...
                  child: Column(
                    children: <Widget>[
                      InputTextWithLabel(
                        ...
                        hintText:
                            IntlUtil.getString(context, Ids.input_new_pwd_hint),
                      ),
                      InputTextWithLabel(
                        ...
                        hintText: IntlUtil.getString(
                            context, Ids.input_new_repwd_hint),
                      ),
                    ],
                  ),
                ),
              ...
              RoundButton(
                ...
                text: IntlUtil.getString(context, Ids.modify),
              )
            ],
          ),
        ));
